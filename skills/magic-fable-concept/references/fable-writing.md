...
## Avoid List
- 不要用这些开头："从前有个地方……""某天某人遇见某事……""在很远的山里……"
- 直接从动作、物件、交易、故障或一句具体台词开始

## Output Format
按三部分输出：

### Part 1: Fable Body
直接输出故事，不加标题、不加引导语。正文内不要点破概念。

### Part 2: Concept Analysis
- 写清概念名称、所属流派或学科、核心定义
- 逐一对应故事元素与概念构成：角色、物件、动作、转折分别映射什么
...
2. 是否避开禁用开头
3. 是否只用了 2-3 个角色
4. 是否有一个清晰场景和至少一次有效转折
5. 解析是否准确，不为了贴故事而扭曲概念
6. 两个问题是否具体、可回答、能检验理解和迁移
