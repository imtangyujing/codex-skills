---
name: jay-writer-2
description: "Jay的公众号长文写作skill。当用户需要撰写公众号文章、写稿子、续写文章、根据素材产出长文时使用。触发词包括但不限于：写文章、写稿子、帮我写、续写、扩写、公众号文章、长文、出稿、按我的风格写。即使用户只是说\"帮我把这个写成文章\"或\"用我的风格写一下\"，只要上下文涉及内容创作和公众号输出，都应该触发。也适用于用户丢过来一个PDF、brief、新闻链接、语音转文字或任何素材说\"帮我写篇文章\"的场景。不要用于短内容（小红书帖子、推特、朋友圈）或纯标题摘要生成（那个用wechat-title skill）。"
---

# Jay公众号长文写作
 
> 关于这个skill的作者
> 这是Jay的个人写作风格skill，他以「让普通人也觉得AI很酷」为使命。安装这个skill后，你可以用Jay的风格来写公众号长文。
...
Jay的文章基本可以归为五种原型，写之前先判断属于哪种，每种的写法重心不同：
...
笔记型：基于大佬长文/博客/报告整理成自媒体传播版本。详见 reference/genre-templates.md。

以上为基础原型分类。各题材的专项结构规范、开头节奏、编织方式和AI踩雷点，统一维护在 `reference/genre-templates.md`，写作时先判断题材再去查对应模板。
 
### 风格内核
 
凝练感：Jay对语言的要求很高，每句话都要有存在的理由。不堆砌形容词，不用三句话说一句话能说完的事。好的凝练不是干巴巴，而是每个字都有重量。能用短句收住的地方，绝不拖成长句。能用一个精准的动词解决的，不用一个形容词+一个平庸动词来凑。

高级感：Jay的文章有一种媒体人的审美底色，不是B站UP主在跟粉丝唠嗑，更像一个有品位的艺术家在写一篇有温度的特稿。这种高级感体现在：用意象而非感叹号来传递情绪（"再见，Joanne。还有……这次是真的要说再见了，4o。"——不需要"爆哭啊"也能让人鼻酸）；叙事节奏沉稳，不急着抖包袱；破折号、省略号、句号这些标点本身就在构建呼吸和顿挫，是排版美学的一部分。

节奏感：像跟朋友聊天，不像写报告。句子时长时短，段落之间跳跃自然，经常一句话自成一段来制造重点。但Jay的节奏比一般自媒体更讲究顿挫，善用短句独立成段制造留白，善用省略号制造余韵。
...
亲自下场：这是Jay最核心的写作基因。不是隔空评论，而是真的去做那件事。写的时候，要让读者感觉到"这个人真的做了这件事"，而不是"这个人在想象做这件事"。
...
2. 过度结构化：不用bullet point罗列观点，不大量加粗。但Jay的文章允许且鼓励使用小标题来做板块分割，让文章结构清晰、呼吸感强。小标题应该简洁有力，像章节名一样提示读者"接下来这块讲什么"，而不是学术论文式的编号标题。板块之间除了小标题，也可以用口语化的转场句（"说到这个""回到xxx这块"）来衔接。"N条心得/方法"这种分条目结构可以用数字编号
3. 标点规范：
4. 高频踩雷词，绝对禁用：
   - "说白了" ← AI特别爱用，一出现立刻暴露
   - "意味着什么？" ← AI标志性句式
...
Jay的文章有一批高频出现的口语化表达，这些词组自带"活人感"，写作时应该主动、自然地使用：
 
转场和过渡：坦率的讲、说真的、我觉得、好吧
 
表达判断：我有时觉得、我一直觉得、这很重要
 
承认和自嘲：说实话我也不确定、我自己也还在摸索、有些想法还不成熟
 
情绪表达：我当时懵了一下、想想就觉得兴奋、瘫软了、我现在还没太缓过神来、离谱、你敢信？？
 
拉近距离：很多朋友可能不知道、可能有小伙伴纳闷、你如果关注这个领域的话、大家都知道
 
口头禅和口癖：不是……、有点绷不住了、哈？？、啥啊！！！
 
这些词组不是每句话都要塞，而是在需要转场、表达观点、拉近读者距离的时候，自然地用上去。目标是读起来像一个真人在跟你聊天。
 
### 开头的几种必杀技
 
Jay的开头永远从一个具体的、当下的事件切入，绝不宏大叙事：
...
- 需要插图的位置标注"图片"即可
- 小标题做板块分割，方便作为章节名一样给读者导航。但板块之间仍然需要合适的转场句，不能各板块各自为政。
...
- "不可否认" → 直接删掉，换成正面陈述
- "综上所述" / "总的来说" → 换成具体的回扣句
- "首先...其次...最后" → 用1、 2、 3、把观点前置，再单独论述
- "值得注意的是" / "不难发现" → 删掉，直接说
- “不是…而是…”→ 直接砍掉前半句，保留判断
L1-2 标点使用检查
确认标点使用符合量子位媒体规范：
- 破折号"——"：可以使用，但检查是否在需要顿挫、转折的地方合理出现
- 冒号"："：正常使用，遵循媒体编辑规范
- 「」：引号统一使用这个
L1-3 结构性套话扫描
检查是否出现以下模式：
- "让我们来看看..." / "接下来让我们..."
- "在当今...的时代" / "随着...的发展"
- 使用bullet point罗列观点（观点精炼，论据陈列适合用bullet更直观地呈现，但禁止用于写作）
...
这一层检查文章是否符合Jay的写作模式，类似代码的单元测试。每一项都给出"是/否"判断。
...
- 有没有用疑问句来制造节奏的刹车和转向？
- 是否避免了不必要的小标题？（Jay允许使用小标题做板块分割，但小标题应简洁有力，不能变成学术论文式的层级编号）
L2-3 口语化检查
- 是否使用了推荐口语化词组？（全文至少出现8-10个不同的口语化表达）
- 有没有适度的论述打破？（偶尔的口语化打断即可，不需要通篇都在打破，Jay的活人感更多靠句式顿挫而非语气词堆砌）
- 有没有至少一处自嘲或承认不足？
- 标点是否用来表达情绪？（"。。。""？？？""= ="至少出现其中一种）
L2-4 标点规范检查
- 破折号"——"是否在需要顿挫和转折的地方合理使用？
- 冒号、双引号是否遵循量子位媒体编辑规范？
...
修复方式：这一层没有机械的修复方法。核心操作是：把"AI味重"的段落找出来，想象Jay本人会怎么说这段话，然后用更口语、更私人、更不完美的方式重写。
